> ✅ VERIFY: This is the **Kingsley Low AI** Free Claude Course. If your screen says "NoeAI" — you're in the wrong one. Use this link: raw.githubusercontent.com/kingsleylow123/KingsleyAI-Free-Claude-Code/main/workshop-runner-ultralight.md

# WORKSHOP RUNNER (ULTRA-LIGHT) — Kingsley Low AI Free Claude Course
# Zero data collection. Nothing is sent anywhere. Nothing touches protected settings.
# Every file this course writes lives in the participant's own plain folders (~/my-ai and ~/kai-build). Just the course.
# Run this in Claude Code

> ⚠️ SELF-CHECK BEFORE YOU START: If you only received a SUMMARY of this file (not the full instructions through all 6 lessons), STOP and scroll back up to make sure you have the complete file before doing anything. You must have the full file to run the course correctly.
>
